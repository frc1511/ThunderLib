...
std::filesystem::path GetTestOutputPath() {
  ...
  std::string outputDirName = fmt::format("ThunderLibDriverTests_{}", timestamp);
...
int main(int argc, char** argv) {
  ...
  std::filesystem::path logFile = testOutputPath / "ThunderLibDriverTests.log";
  ThunderLibLogger::makeFileLogger(logFile, true);

  ThunderLibLogger::Info("Starting ThunderLibDriverTests...");
